      ...
      try {
        ...
        if (intensityData.length > 0) {
          ...
          intensityData.forEach(entry => {
            ...
            if (!entry.intensity_scores || !Array.isArray(entry.intensity_scores) || entry.intensity_scores.length === 0) {
              // Log it but don't treat as an error - we'll analyze the text directly
              console.log(`Entry has no intensity_scores, analyzing text directly: "${entry.text}"`);
              
              // Simple keyword analysis as a fallback
              const anxietyKeywords = ["anxious", "anxiety", "nervous", "worry", "panic", "fear"];
              const depressionKeywords = ["depressed", "depression", "sad", "hopeless", "empty", "down"];
              const stressKeywords = ["stress", "stressed", "overwhelmed", "pressure", "tension"];
              ...
              if (anxietyKeywords.some(keyword => text.includes(keyword))) {
                ...
                setAlerts(prevAlerts => {
                  const alertExists = prevAlerts.some(alert => alert.id === alertId);
            ...
            entry.intensity_scores.forEach(scoreItem => {
              ...
              if (!scoreItem || typeof scoreItem.score !== 'number' || !scoreItem.concern) {
                return;
              }
              ...
              if (scoreItem.score > 8) {
                ...
                setAlerts(prevAlerts => {
                  ...
                  if (!alertExists) {
                    console.log(`New high intensity alert: ${scoreItem.concern} - ${scoreItem.score}`);
      ...
      <div className="report-container">
        <div className="fixed top-0 left-0 w-full bg-slate-800 p-4 z-50 flex items-center">
          ...
          <h2 className="text-xl font-bold text-white ml-4">
            {selectedAlertForReport.concern} Report for {selectedAlertForReport.patient}
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-slate-800 p-6 rounded-xl">
            <h2 className="text-xl font-semibold mb-4 flex items-center">
              ...
              <span className="text-sm text-slate-400 ml-2">(Scores &gt; 8)</span>
            </h2>
            ...
            {!loading && !error && alerts.length === 0 && (
              <p className="text-slate-400">No high intensity alerts at this time.</p>
            )}
          ...
          <div className="bg-slate-800 p-6 rounded-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-700/50 p-4 rounded-lg">
                <h3 className="text-sm text-slate-400 mb-1">Patients Monitored</h3>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-slate-800 p-6 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-auto">
                  ...
                  <details className="mb-4">
                    <summary className="cursor-pointer text-slate-400 hover:text-white mb-2">View Raw JSON Data</summary>
                    <div className="bg-slate-700 p-4 rounded-lg">
