...
const ReportPage = () => {
  ...
  const cardColors = {
    blue: { bg: 'bg-blue-900', text: 'text-blue-100', hover: 'hover:bg-blue-800' },
    indigo: { bg: 'bg-indigo-900', text: 'text-indigo-100', hover: 'hover:bg-indigo-800' },
    purple: { bg: 'bg-purple-900', text: 'text-purple-100', hover: 'hover:bg-purple-800' },
    pink: { bg: 'bg-pink-900', text: 'text-pink-100', hover: 'hover:bg-pink-800' },
    green: { bg: 'bg-green-900', text: 'text-green-100', hover: 'hover:bg-green-800' },
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-100 mb-4">No Data Available</h2>
          <button 
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className={`p-2 rounded-lg ${cardColors[card.color].bg}`}>
                  {React.cloneElement(card.icon, { className: cardColors[card.color].text })}
                </div>
